...
function App() {
  ...
  return (
    <div className="min-h-screen bg-black text-gray-100">
      {/* Navigation */}
      <nav className="fixed w-full bg-black/95 backdrop-blur-sm z-40 border-b border-[#A31621]/20">
          ...
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden md:block">
              <div className="ml-10 flex items-baseline space-x-4">
                <a href="#home" className="text-gray-300 hover:text-[#A31621] px-3 py-2 transition-colors">Inicio</a>
                <a href="#products" className="text-gray-300 hover:text-[#A31621] px-3 py-2 transition-colors">Productos</a>
                <a href="#contact" className="text-gray-300 hover:text-[#A31621] px-3 py-2 transition-colors">Contacto</a>
              </div>
            </div>
            ...
            <div className="md:hidden">
              <button
                ...
                className="text-gray-400 hover:text-[#A31621] focus:outline-none"
              >
        ...
        {isMenuOpen && (
          <div className="md:hidden">
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-black/95 backdrop-blur-sm">
              <a href="#home" className="block px-3 py-2 text-gray-300 hover:text-[#A31621] transition-colors">Inicio</a>
              <a href="#products" className="block px-3 py-2 text-gray-300 hover:text-[#A31621] transition-colors">Productos</a>
              <a href="#contact" className="block px-3 py-2 text-gray-300 hover:text-[#A31621] transition-colors">Contacto</a>
            </div>
          </div>
        )}
      </nav>
